...
%% Confronto analisi in frequenza tra task
...
for i = 1 : size(task,2)
    ...
    % strutture dati
    VX_01_15_structure{i,:} = VX_01_15;
    VX_15_30_structure{i,:} = VX_15_30;
    VX_30_45_structure{i,:} = VX_30_45;
...
%% Confronto Analisi in frequenza tra task
%% CAMMINATA vs DORMITA

[RWS01_15,PWS01_15] = corrcoef(abs(VX_01_15_structure{1,1}),abs(VX_01_15_structure{4,1}));
[RWS15_30,PWS15_30] = corrcoef(abs(VX_15_30_structure{1,1}),abs(VX_15_30_structure{4,1}));
[RWS30_45,PWS30_45] = corrcoef(abs(VX_30_45_structure{1,1}),abs(VX_30_45_structure{4,1}));

%% CAMMINATA vs SCALE

[RWSt01_15,PWSt01_15] = corrcoef(abs(VX_01_15_structure{1,1}),abs(VX_01_15_structure{3,1}));
[RWSt15_30,PWSt15_30] = corrcoef(abs(VX_15_30_structure{1,1}),abs(VX_15_30_structure{3,1}));
[RWSt30_45,PWSt30_45] = corrcoef(abs(VX_30_45_structure{1,1}),abs(VX_30_45_structure{3,1}));
